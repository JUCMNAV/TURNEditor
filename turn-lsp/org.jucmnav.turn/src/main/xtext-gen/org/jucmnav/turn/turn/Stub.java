 ...
 * </p>
 * <ul>
 *   <li>{@link org.jucmnav.turn.turn.Stub#getStubType <em>Stub Type</em>}</li>
 *   <li>{@link org.jucmnav.turn.turn.Stub#getIndex <em>Index</em>}</li>
 *   <li>{@link org.jucmnav.turn.turn.Stub#getName <em>Name</em>}</li>
 *   <li>{@link org.jucmnav.turn.turn.Stub#getLongName <em>Long Name</em>}</li>
 *   <li>{@link org.jucmnav.turn.turn.Stub#getParams <em>Params</em>}</li>
 *   <li>{@link org.jucmnav.turn.turn.Stub#getStubRef <em>Stub Ref</em>}</li>
 *   <li>{@link org.jucmnav.turn.turn.Stub#getOutPaths <em>Out Paths</em>}</li>
 *   <li>{@link org.jucmnav.turn.turn.Stub#getConnectingStubBody <em>Connecting Stub Body</em>}</li>
 * </ul>
 *
 * @see org.jucmnav.turn.turn.TurnPackage#getStub()
 * @model
 * @generated
 */
public interface Stub extends URNmodelElement, RegularEnd, ReferencedEnd
{
   ...
   * The literals are from the enumeration {@link org.jucmnav.turn.turn.StubType}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.jucmnav.turn.turn.TurnPackage#getStub_StubType()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.jucmnav.turn.turn.Stub#getStubType <em>Stub Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setIndex(int)
   * @see org.jucmnav.turn.turn.TurnPackage#getStub_Index()
   * @model
   * @generated
   */
  int getIndex();
  ...
  /**
   * Sets the value of the '{@link org.jucmnav.turn.turn.Stub#getIndex <em>Index</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setName(String)
   * @see org.jucmnav.turn.turn.TurnPackage#getStub_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.jucmnav.turn.turn.Stub#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.jucmnav.turn.turn.TurnPackage#getStub_LongName()
  ...
  /**
   * Sets the value of the '{@link org.jucmnav.turn.turn.Stub#getLongName <em>Long Name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.jucmnav.turn.turn.TurnPackage#getStub_Params()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.jucmnav.turn.turn.Stub#getParams <em>Params</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.jucmnav.turn.turn.TurnPackage#getStub_StubRef()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.jucmnav.turn.turn.Stub#getStubRef <em>Stub Ref</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link org.jucmnav.turn.turn.StubOutPath}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.jucmnav.turn.turn.TurnPackage#getStub_OutPaths()
   * @model containment="true"
   * @generated
   */
   ...
   * @see org.jucmnav.turn.turn.TurnPackage#getStub_ConnectingStubBody()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.jucmnav.turn.turn.Stub#getConnectingStubBody <em>Connecting Stub Body</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
