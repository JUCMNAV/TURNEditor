 ...
 * </p>
 * <ul>
 *   <li>{@link org.jucmnav.turn.turn.Contribution#getName <em>Name</em>}</li>
 *   <li>{@link org.jucmnav.turn.turn.Contribution#getLongName <em>Long Name</em>}</li>
 *   <li>{@link org.jucmnav.turn.turn.Contribution#getDest <em>Dest</em>}</li>
 *   <li>{@link org.jucmnav.turn.turn.Contribution#isCorrelation <em>Correlation</em>}</li>
 *   <li>{@link org.jucmnav.turn.turn.Contribution#getContribution <em>Contribution</em>}</li>
 *   <li>{@link org.jucmnav.turn.turn.Contribution#getQuantitativeContribution <em>Quantitative Contribution</em>}</li>
 * </ul>
 *
 * @see org.jucmnav.turn.turn.TurnPackage#getContribution()
 * @model
 * @generated
 */
public interface Contribution extends URNmodelElement, ElementLink
{
   ...
   * @see #setName(String)
   * @see org.jucmnav.turn.turn.TurnPackage#getContribution_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.jucmnav.turn.turn.Contribution#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.jucmnav.turn.turn.TurnPackage#getContribution_LongName()
  ...
  /**
   * Sets the value of the '{@link org.jucmnav.turn.turn.Contribution#getLongName <em>Long Name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.jucmnav.turn.turn.TurnPackage#getContribution_Dest()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.jucmnav.turn.turn.Contribution#getDest <em>Dest</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.jucmnav.turn.turn.TurnPackage#getContribution_Correlation()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.jucmnav.turn.turn.Contribution#isCorrelation <em>Correlation</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The literals are from the enumeration {@link org.jucmnav.turn.turn.ContributionType}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.jucmnav.turn.turn.TurnPackage#getContribution_Contribution()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.jucmnav.turn.turn.Contribution#getContribution <em>Contribution</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.jucmnav.turn.turn.TurnPackage#getContribution_QuantitativeContribution()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.jucmnav.turn.turn.Contribution#getQuantitativeContribution <em>Quantitative Contribution</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
