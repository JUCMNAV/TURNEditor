...
import org.jucmnav.turn.ide.ExtensionProvider;
import org.jucmnav.turn.ide.extensions.ICommandExtension;
import org.jucmnav.turn.ide.settings.PreferenceValuesProvider;
              ...
              for (final String c : _commands) {
                try {
                  ...
                  if (_t instanceof Exception) {
                    final Exception e = (Exception)_t;
                    String _message = e.getMessage();
                    String _plus = ("Error registering commands : " + _message);
                    CommandService.LOG.warn(_plus);
                    this.dispose();
                    return;
                  } else {
